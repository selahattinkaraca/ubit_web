        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('sponsors.update', $sponsor->id) }}" enctype="multipart/form-data"
                          method="post">

                        <div class="row mb-4">
                            <label for="slug" class="col-sm-3 col-form-label">Sıra</label>
                            <div class="col-sm-4">
                                <input value="{{$sponsor->slug}}" type="number" class="form-control @error('slug') is-invalid @enderror" name="slug" id="slug" required>
                                @error('slug')
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="title" id="title-input" value="{{$sponsor->title}}" required>
                            </div>
                        </div>
