            ...
            <div class="card-body">
                ...
                <form action="{{ route('contacts.store') }}" enctype="multipart/form-data" method="post">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="mail" id="title-input" required>
                        </div>
                    </div>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="phone_number" id="title-input" required>
                        </div>
                    </div>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="embed" id="title-input" required>
                        </div>
                    </div>
